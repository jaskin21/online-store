  ...
  return (
    <div className='container mx-auto px-6 py-3'>
      <div className='flex items-center justify-between'>
        ...
        <div className='w-full md:text-center text-4xl font-semibold'>
          {shopInfo.shopName}
        </div>
        <div className='flex items-center justify-end w-full '>
          <button
            onClick={handleCart}
            className='text-slate-800 focus:outline-none mx-4 sm:mx-0 relative'
          >
            <svg
              className='h-10 w-10'
              fill='none'
            ...
            <span className=' absolute left-5 bottom-5 bg-red-600 rounded-full top right p-0 m-0 text-white  text-sm p-1'>
              <p>2000</p>
            </span>
          </button>
      ...
      <div className='relative mt-6 max-w-lg mx-auto'>{children}</div>
    </div>
  );
};
